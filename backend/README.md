...
## Project Structure
    ...
    ├── testapiautosetting_122782  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_122782`
...
2. Clone this repo and `cd testapiautosetting_122782`
